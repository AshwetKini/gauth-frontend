...
function ServiceCard({ service, onClick }: ServiceCardProps) {
  ...
  const isFeatured = service.isFeatured || service.isFeaturedService || false;
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center text-sm text-gray-500">
            ...
            <span>{rating} {reviewCount > 0 ? `(${reviewCount})` : ''}</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between text-sm border-t pt-3">
          <div>
            ...
            {subCategory && (
              <div className="text-gray-400 text-xs">{subCategory}</div>
            )}
          </div>
          <div className="text-right">
            <div className="text-gray-700 font-medium">{hustlerName}</div>
          </div>
        </div>
        
        <button className="mt-3 w-full px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-colors text-sm font-medium">
          View Details
        </button>
      </div>
    </div>
